...
from ai_engine.agents.phishing.graph import GRAPH
...
@router.post(
    ...
    summary="Analyse an email, URL, or domain for phishing",
)
async def analyze(payload: AnalyzeRequest) -> AnalyzeResponse:
    """Run the phishing detection graph over one artifact.
